...
from transformers.models.qwen3.modeling_qwen3 import (Callable, Optional, Tuple, Union, torch, nn, ACT2FN, Cache, GenerationMixin, FlashAttentionKwargs, BaseModelOutputWithPast, CausalLMOutputWithPast, ROPE_INIT_FUNCTIONS, dynamic_rope_update, ALL_ATTENTION_FUNCTIONS, PreTrainedModel, Unpack, add_start_docstrings, add_start_docstrings_to_model_forward, can_return_tuple, replace_return_docstrings, deprecate_kwarg, Qwen3Config, logger, __name__, _CONFIG_FOR_DOC, Qwen3PreTrainedModel, QWEN3_INPUTS_DOCSTRING, Qwen3Model, KwargsForCausalLM, Qwen3ForCausalLM)
